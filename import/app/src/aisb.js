...
import { Button } from '@wordpress/components';
 ...
 function Upgrade(props) {
    ...
    return (<>{props.btn && <a href={HCLOCAL.upgrade} target='_blank'>
...
function Logo() {
    ...
    <a href={'?page=themehunk-site-library'} ><img src={HCLOCAL.rootPath+"import/admin/assets/images/logo.png"} alt="themehunk Logo" /></a>
    </div>)
    }
