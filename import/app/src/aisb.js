...
import { Button } from '@wordpress/components';
 ...
 function Upgrade(props) {
    ...
    return (<>{props.btn && <a href={THCLOCAL.upgrade} target='_blank'>
...
function Logo() {
    ...
    <a href={'?page=themehunk-site-library'} ><img src={THCLOCAL.rootPath+"import/admin/assets/images/logo.png"} alt="themehunk Logo" /></a>
    </div>)
    }
